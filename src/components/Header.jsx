...
class Header extends React.Component {
    ...
    logout = () => {
        window.open("http://traderjoesapi-wacky-tiger-ir.mybluemix.net/auth/logout", "_self");
    };
    constructor() {
        super();
    ...
    render() {
        // console.log('123');
        const google = () => {
            window.open("http://traderjoesapi-wacky-tiger-ir.mybluemix.net/auth/google", "_self");
        };

        const github = () => {
            window.open("http://traderjoesapi-wacky-tiger-ir.mybluemix.net/auth/github", "_self");
        };

        const facebook = () => {
            window.open("http://traderjoesapi-wacky-tiger-ir.mybluemix.net/auth/facebook", "_self");
        };
